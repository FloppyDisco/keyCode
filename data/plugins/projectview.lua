...
function ProjectView:new()
   ...
   local split_direction = toolbar_location == "top" and "down" or "up"
   ProjectView.node = ProjectView.node:split(split_direction, self.tree, {x=true}, true)

   for item in self:files() do
      print("----")
      print(item)
...
function ProjectView:get_cached(dir, item, dirname)
...
function ProjectView:check_cache()
  ...
  for i = 1, #core.project_directories do
   print("project directory found,----", core.project_directories[i])
